...
var AUTH_ENDPOINT = "https://test.salesforce.com/services/oauth2/authorize";
var TEST_AUTH_ENDPOINT =
  "https://test.salesforce.com/services/oauth2/authorize";
var LOGIN_URI = "https://test.salesforce.com/services/oauth2/token";
...
var Connection = function(opts) {
  ...
  if (
    ...
    _.indexOf(ENVS, this.environment) === -1
  ) {
    throw new Error(
      "invalid environment, only " + ENVS.join(" and ") + " are allowed"
    );
  }
  if (!_.isString(this.mode) || _.indexOf(MODES, this.mode) === -1) {
    throw new Error(
      "invalid mode, only " + MODES.join(" and ") + " are allowed"
    );
  }
...
Connection.prototype._apiRequest = function(opts, callback) {
  ...
  if (opts.uri) {
    ...
    ropts.uri = [
      opts.oauth.instance_url,
      "/services/apexrest/IntegrationInvitae"
    ].join("");
  }
...
// // Data Model
// {
// 	"u_int_type":"Client New Contact",
// 	"u_int_account":"Client",
// 	"u_contact_id":"f56c3901ff900100b9a38axxxxxxxxxx",
// 	"u_first_name":"John",
// 	"u_last_name":"Smith”,
// 	“u_email”:”JSmith@test.com”,
// 	“u_contact_status”:”true”
// }
