...
let formatAccounts = accounts => {
  if (accounts && accounts.length > 0) {
    ...
    accounts.forEach(account => {
      ...
      fields.push({
        title: "Link",
        value: "https://login.salesforce.com/" + account.getId(),
        short: true
      });
...
let formatContacts = contacts => {
  if (contacts && contacts.length > 0) {
    ...
    contacts.forEach(contact => {
      ...
      fields.push({
        title: "Link",
        value: "https://login.salesforce.com/" + contact.getId(),
        short: false
      });
...
let formatOpportunities = opportunities => {
  if (opportunities && opportunities.length > 0) {
    ...
    opportunities.forEach(opportunity => {
      ...
      fields.push({
        title: "Link",
        value: "https://login.salesforce.com/" + opportunity.getId(),
        short: false
      });
...
let formatCase = _case => {
  ...
  fields.push({
    title: "Link",
    value: "https://login.salesforce.com/" + _case.get("id"),
    short: true
  });
